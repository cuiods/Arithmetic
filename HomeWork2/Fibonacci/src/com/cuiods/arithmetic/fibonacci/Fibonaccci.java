package com.cuiods.arithmetic.fibonacci;
...
public class Fibonaccci {
     ...
     * @return
     */
    private BigInteger recursiveFibonacci(int num) {
     ...
     * @return
     */
    private BigInteger bottomUpFibonacci(int num) {
        if (num == 0) return BigInteger.ZERO;
        if (num == 1) return BigInteger.ONE;
     ...
     * @return
     */
    private BigInteger matrixFibonacci(int num) {
        if (num == 0) return BigInteger.ZERO;
        if (num == 1) return BigInteger.ONE;
     ...
     * @return
     */
    private long formulaFibonacci(int num) {
    ...
    public static void main(String[] args) {
        Fibonaccci fibonaccci = new Fibonaccci();
        System.out.println(fibonaccci.formulaFibonacci(89));
    }
